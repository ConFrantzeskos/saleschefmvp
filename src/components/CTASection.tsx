      ...
      <div className="content-width">
        <div className="text-center animate-fade-in">
          <div className="bg-gradient-to-br from-muted to-muted/50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 max-w-xl sm:max-w-2xl mx-auto border border-border shadow-medium">
            <h3 className="text-xl sm:text-2xl lg:text-3xl font-display font-bold mb-4 sm:mb-6 text-balance">Ready to Transform Your Content Operations?</h3>
            ...
            <p className="text-xs sm:text-sm text-muted-foreground mt-4 sm:mt-6">
              Get instant demo access via magic link • No setup required
            </p>
          </div>
        </div>
      </div>
