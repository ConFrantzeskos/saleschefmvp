    ...
    <section className="section-spacing bg-gradient-to-b from-background to-muted/30">
      <div className="content-width">
        ...
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          <div className="bg-gradient-to-br from-muted/40 to-muted/20 rounded-3xl p-8 border border-border/50 shadow-soft animate-slide-up max-w-3xl mx-auto" style={{ animationDelay: '0.8s' }}>
            ...
            <div className="space-y-6">
              <div className="bg-destructive/5 border border-destructive/20 rounded-2xl p-6">
                ...
                <p className="text-sm text-destructive/80">→ Hard to differentiate, variable SEO performance, poor conversion</p>
              </div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-2xl p-6">
                <h4 className="font-display font-semibold text-yellow-600 mb-2">Bland, identical PDPs</h4>
                <p className="text-sm text-yellow-600">→ If everyone's PDPs look the same, the only way to compete is by investing in performance media and/or price competition.</p>
              </div>
              
              <div className="bg-destructive/5 border border-destructive/20 rounded-2xl p-6 text-center">
                <h4 className="font-display font-semibold text-destructive text-xl mb-2">Poor ROI</h4>
