          ...
          <div className="text-center animate-slide-up">
            <div className="grid grid-cols-1 gap-4">
              {problems.map((problem, index) => (
                <div 
                  key={index} 
                  className="flex items-start gap-4 p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-white dark:bg-card border-2 border-red-200/50 dark:border-red-900/30 hover:border-red-300 dark:hover:border-red-800 hover:bg-red-50/50 dark:hover:bg-red-950/20 transition-all duration-300 group text-left shadow-sm hover:shadow-md" 
                ...
                >
                  ...
                  <div className="flex-1">
                    <span className="text-foreground font-medium leading-relaxed text-sm sm:text-base group-hover:text-red-800 dark:group-hover:text-red-200 transition-colors">
                      {problem.text}
                    </span>
                  </div>
                </div>
