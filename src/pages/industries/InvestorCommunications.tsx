      ...
      <PageSection>
        <div className="text-center">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">
            Ready to transform your <span className="text-primary">investor communications engine</span>?
          </h2>
          <p className="text-lg text-muted-foreground mb-8">
            Custom-tailored for your business: public company IR, investment firm, PE/VC, asset manager, sovereign wealth fund, or IR agency.
          </p>
          <Link to="/pricing">
