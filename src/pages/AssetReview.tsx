...
const AssetReview = () => {
  ...
  // Raw factory data (left side) - purely technical specs, incomplete
  const rawData = {
    model: "CD1234",
    driver: "40mm",
    freq_range: "20-20000",
  ...
  const contentSections = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          rawContent: "freq_range: 20-20000\nimpedance: 32",
                    ...
                    <div className="space-y-4">
                      ...
                      {section.items.map((item, itemIndex) => (
                        <div key={itemIndex} className="border border-red-200 bg-red-50 p-3 rounded-md">
                          ...
                          <div className="text-sm text-red-600 whitespace-pre-line font-mono">
                            {item.rawContent}
                          </div>
                        </div>
                      ))}
